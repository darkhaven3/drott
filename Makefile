...
am__DIST_COMMON = $(srcdir)/Makefile.in COPYING README compile \
...
PACKAGE_BUGREPORT = 
PACKAGE_NAME = drott
PACKAGE_STRING = drott 0.1.3
PACKAGE_TARNAME = drott
PACKAGE_URL = 
...
SUFFIX = 
VERSION = 0.1.3
abs_builddir = /d/drott/drott-staging
abs_srcdir = /d/drott/drott-staging
